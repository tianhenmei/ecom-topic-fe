...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            setAll(e){
                let id = this.props.id,
                    top = this.$parent.$refs['yh-custom-select0-h5'],
                    right = this.$parent.$refs['yh-custom-select1-h5'],
                    bottom = this.$parent.$refs['yh-custom-select2-h5'],
                    left = this.$parent.$refs['yh-custom-select3-h5'],
