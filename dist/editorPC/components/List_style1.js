...
exports.default = {
    ...
    methods: {
        ...
        addElement: function addElement(e) {
            var childmodule = this.props.data.childmodule.value,
    ...
    recoveryCtor: function recoveryCtor(elem, options, components) {
        var data = Object.assign({}, (0, _Node.recoveryData)(elem, baseData), this.methods.recoveryModuleData(elem, baseData), (0, _Node.recoveryChildElementsData)(elem, baseData, components, 'List_style1', 'ignorestatus'), {
            yh_data_name: baseData.yh_data_name,
            path: path,
            nonset: baseData.nonset,
            common: baseData.common
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ref: _vm.props.id,
    staticClass: "list-style1 background clearfix",
    class: {
      'yh-list-style1': _vm.props.elements.length > 0
    },
    style: ({
    ...
    attrs: {
      ...
      "background_background_image_h5": _vm.props.h5css.background_background_image_h5.value,
      "yh-path": _vm.path,
      "yh-vessel": ""
    },
    on: {
    ...
    staticClass: "yh-list-content clearfix",
    class: {
    ...
    directives: [{
      name: "show",
      rawName: "v-show",
      value: (_vm.props.css.overflow.cnvalue == '滚动'),
      expression: "props.css.overflow.cnvalue == '滚动'"
    }],
    attrs: {
      "id": _vm.props.id + '-bar'
    }
    ...
    staticClass: "yh-list-initcontent"
  }, [_vm._v("选中添加组件")]), _vm._v(" "), _c('div', {
    directives: [{
      name: "show",
      rawName: "v-show",
      value: (_vm.props.elements.length > 0),
    ...
    ref: "yh-list-addone",
    staticClass: "yh-vessel-add yh-list-addone hide",
    on: {
      "click": function($event) {
        $event.preventDefault();
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-loader/node_modules/vue-hot-reload-api").rerender("data-v-48aea420", module.exports)
  }
}
...
var update = __webpack_require__(2)("71270971", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-48aea420\",\"scoped\":false,\"hasInlineConfig\":false}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./index.vue", function() {
     var newContent = require("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-48aea420\",\"scoped\":false,\"hasInlineConfig\":false}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./index.vue");
    ...
    methods: {
        ...
        setValue: function setValue(e) {
            ...
            index = parseInt(target.attributes['index'].value),
                svalue = this.options.options[index],
                // 展示出来的字体大小（针对750的宽）
...
// module
exports.push([module.i, ".list-style1{margin:0 auto;background:transparent no-repeat center top}.yh-list-content{margin:0 auto}", ""]);
...
Component.options.__file = "/Users/dagou/Documents/workspace/20161117work/ecom-topic-fe/src/editorPC/components/List/style1/index.vue"
if (Component.esModule && Object.keys(Component.esModule).some(function (key) {return key !== "default" && key.substr(0, 2) !== "__"})) {console.error("named exports are not supported in *.vue files.")}
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-48aea420", Component.options)
  } else {
    hotAPI.reload("data-v-48aea420", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
