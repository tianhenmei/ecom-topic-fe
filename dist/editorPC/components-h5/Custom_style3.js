...
exports.default = {
    ...
    computed: {
        ...
        setbuttonButtonStyle: function setbuttonButtonStyle() {
            var style = '' + 'color:' + this.props.h5css.button_button.value.button_color.value + '; ';
            switch (this.props.h5css.button_button.value.button_background_type.value) {
                case 'background-color':
                    style += 'background:' + this.props.h5css.button_button.value.button_background_color.value + '; ';
                    break;
                case 'background-image':
                    style += 'background:' + this.props.h5css.button_button.value.button_background_color.value + ' ' + (this.props.h5css.button_button.value.button_background_image.value == 'none' || this.props.h5css.button_button.value.button_background_image.value == 'undefined' ? 'none' : 'url(' + this.props.h5css.button_button.value.button_background_image.value + ')') + ' ' + this.props.h5css.button_button.value.button_background_repeat.value + '; ';
                    break;
                case 'gradient-top-bottom':
                    style += '' + 'background:' + this.props.h5css.button_button.value.button_gradient_color_top.value + ';' + 'filter:alpha(opacity=100 finishopacity=100 style=1 startx=0,starty=0,finishx=0,finishy=150) progid:DXImageTransform.Microsoft.gradient(startcolorstr=' + this.props.h5css.button_button.value.button_gradient_color_top.value + ',endcolorstr=' + this.props.h5css.button_button.value.button_gradient_color_bottom.value + ',gradientType=0);' + '-ms-filter:alpha(opacity=100 finishopacity=100 style=1 startx=0,starty=0,finishx=0,finishy=150) progid:DXImageTransform.Microsoft.gradient(startcolorstr=' + this.props.h5css.button_button.value.button_gradient_color_top.value + ',endcolorstr=' + this.props.h5css.button_button.value.button_gradient_color_bottom.value + ',gradientType=0);' + 'background:-moz-linear-gradient(top, ' + this.props.h5css.button_button.value.button_gradient_color_top.value + '), ' + this.props.h5css.button_button.value.button_gradient_color_bottom.value + '); ' + 'background:-o-linear-gradient(top, ' + this.props.h5css.button_button.value.button_gradient_color_top.value + '), ' + this.props.h5css.button_button.value.button_gradient_color_bottom.value + '); ' + 'background:-webkit-gradient(linear,0 0,0 100%,color-stop(0%,' + this.props.h5css.button_button.value.button_gradient_color_top.value + '),color-stop(100%,' + this.props.h5css.button_button.value.button_gradient_color_bottom.value + '));' + '';
                    break;
                case 'gradient-left-right':
                    style += '' + 'background:' + this.props.h5css.button_button.value.button_gradient_color_left.value + ';' + 'filter:alpha(opacity=100 finishopacity=100 style=1 startx=0,starty=0,finishx=150,finishy=0) progid:DXImageTransform.Microsoft.gradient(startcolorstr=' + this.props.h5css.button_button.value.button_gradient_color_left.value + ',endcolorstr=' + this.props.h5css.button_button.value.button_gradient_color_right.value + ',gradientType=0);' + '-ms-filter:alpha(opacity=100 finishopacity=100 style=1 startx=0,starty=0,finishx=150,finishy=0) progid:DXImageTransform.Microsoft.gradient(startcolorstr=' + this.props.h5css.button_button.value.button_gradient_color_left.value + ',endcolorstr=' + this.props.h5css.button_button.value.button_gradient_color_right.value + ',gradientType=0);' + 'background:-moz-linear-gradient(left, ' + this.props.h5css.button_button.value.button_gradient_color_left.value + '), ' + this.props.h5css.button_button.value.button_gradient_color_right.value + '); ' + 'background:-o-linear-gradient(left, ' + this.props.h5css.button_button.value.button_gradient_color_left.value + '), ' + this.props.h5css.button_button.value.button_gradient_color_right.value + '); ' + 'background:-webkit-gradient(linear,0 0,100% 0,color-stop(0%,' + this.props.h5css.button_button.value.button_gradient_color_left.value + '),color-stop(100%,' + this.props.h5css.button_button.value.button_gradient_color_right.value + '));' + '';
                    break;
            }
            return style;
        },
        setPositionStyle: function setPositionStyle() {
            var style = '';
            switch (this.props.h5css.position.value.position_background_type.value) {
                case 'background-color':
                    style += 'background:' + this.props.h5css.position.value.position_background_color.value + '; ';
                    break;
                case 'background-image':
                    style += 'background:' + this.props.h5css.position.value.position_background_color.value + ' ' + (this.props.h5css.position.value.position_background_image.value == 'none' || this.props.h5css.position.value.position_background_image.value == 'undefined' ? 'none' : 'url(' + this.props.h5css.position.value.position_background_image.value + ')') + ' ' + this.props.h5css.position.value.position_background_repeat.value + '; ';
                    break;
                case 'gradient-top-bottom':
                    style += '' + 'background:' + this.props.h5css.position.value.position_gradient_color_top.value + ';' + 'filter:alpha(opacity=100 finishopacity=100 style=1 startx=0,starty=0,finishx=0,finishy=150) progid:DXImageTransform.Microsoft.gradient(startcolorstr=' + this.props.h5css.position.value.position_gradient_color_top.value + ',endcolorstr=' + this.props.h5css.position.value.position_gradient_color_bottom.value + ',gradientType=0);' + '-ms-filter:alpha(opacity=100 finishopacity=100 style=1 startx=0,starty=0,finishx=0,finishy=150) progid:DXImageTransform.Microsoft.gradient(startcolorstr=' + this.props.h5css.position.value.position_gradient_color_top.value + ',endcolorstr=' + this.props.h5css.position.value.position_gradient_color_bottom.value + ',gradientType=0);' + 'background:-moz-linear-gradient(top, ' + this.props.h5css.position.value.position_gradient_color_top.value + '), ' + this.props.h5css.position.value.position_gradient_color_bottom.value + '); ' + 'background:-o-linear-gradient(top, ' + this.props.h5css.position.value.position_gradient_color_top.value + '), ' + this.props.h5css.position.value.position_gradient_color_bottom.value + '); ' + 'background:-webkit-gradient(linear,0 0,0 100%,color-stop(0%,' + this.props.css.position.value.position_gradient_color_top.value + '),color-stop(100%,' + this.props.h5css.position.value.position_gradient_color_bottom.value + '));' + '';
                    break;
                case 'gradient-left-right':
                    style += '' + 'background:' + this.props.h5css.position.value.position_gradient_color_left.value + ';' + 'filter:alpha(opacity=100 finishopacity=100 style=1 startx=0,starty=0,finishx=150,finishy=0) progid:DXImageTransform.Microsoft.gradient(startcolorstr=' + this.props.h5css.position.value.position_gradient_color_left.value + ',endcolorstr=' + this.props.h5css.position.value.position_gradient_color_right.value + ',gradientType=0);' + '-ms-filter:alpha(opacity=100 finishopacity=100 style=1 startx=0,starty=0,finishx=150,finishy=0) progid:DXImageTransform.Microsoft.gradient(startcolorstr=' + this.props.h5css.position.value.position_gradient_color_left.value + ',endcolorstr=' + this.props.h5css.position.value.position_gradient_color_right.value + ',gradientType=0);' + 'background:-moz-linear-gradient(left, ' + this.props.h5css.position.value.position_gradient_color_left.value + '), ' + this.props.h5css.position.value.position_gradient_color_right.value + '); ' + 'background:-o-linear-gradient(left, ' + this.props.h5css.position.value.position_gradient_color_left.value + '), ' + this.props.h5css.position.value.position_gradient_color_right.value + '); ' + 'background:-webkit-gradient(linear,0 0,100% 0,color-stop(0%,' + this.props.h5css.position.value.position_gradient_color_left.value + '),color-stop(100%,' + this.props.h5css.position.value.position_gradient_color_right.value + '));' + '';
                    break;
            }
            return style;
        }
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ref: _vm.props.id,
    staticClass: "custom-style3 yh-custom-style3-base-element00",
    style: (_vm.setCustomBackgroundStyle),
    attrs: {
      "id": _vm.props.id,
      "yh-module": "Custom_style3"
    }
  }, [_c('div', {
    staticClass: "yh-custom-style3-base-element0",
    attrs: {
      "id": "custom_h0",
      "path": "elements_h.0",
      "draggable": "false",
    ...
    staticClass: "yh-custom-image yh-custom-style3-base-element1 yh-custom-image-img normal-src",
    attrs: {
      "src": _vm.props.h5css.image_src.value
    }
  }), _vm._v(" "), _c('a', {
    staticClass: "yh-custom-style3-base-element2 yh-custom-image-href yh-custom-href normal-src-href",
    attrs: {
    ...
    staticClass: "yh-custom-style3-base-element3",
    attrs: {
      "id": "custom_h1",
      "path": "elements_h.1",
      "draggable": "false",
    ...
    staticClass: "yh-custom-button yh-custom-style3-base-element4 yh-custom-button-btn",
    style: (_vm.setbuttonButtonStyle)
  }, [_vm._v(_vm._s(_vm.props.data.yh_h5data.value.button_button_text.value) + "\n")]), _vm._v(" "), _c('a', {
    staticClass: "yh-custom-style3-base-element5 yh-custom-button-href yh-custom-href",
    attrs: {
      "lagou-href": 'https://www.lagou.com/gongsi/' + _vm.props.data.companyId.value + '.html',
      "target": "_blank",
      "href": 'https://www.lagou.com/gongsi/' + _vm.props.data.companyId.value + '.html'
    ...
    staticClass: "yh-custom-style3-base-element6",
    attrs: {
      "id": "custom_h2",
      "path": "elements_h.2",
      "draggable": "false",
    ...
    staticClass: "yh-custom-text yh-custom-style3-base-element7 yh-custom-text-text",
    style: ({
      color: _vm.props.h5css.text_color.value,
    }),
    domProps: {
      "innerHTML": _vm._s(_vm.props.data.yh_h5data.value.text_text.value)
    }
  })])]), _c('div', {
    staticClass: "yh-custom-style3-base-element8 yh-position",
    attrs: {
      "id": "custom_h3",
      "path": "elements_h.3",
      "draggable": "false",
    ...
    return _c('div', {
      ...
      staticClass: "yh-custom-style3-base-element9 yh-custom-position-href yh-custom-href position-href",
      attrs: {
        "lagou-href": 'https://www.lagou.com/jobs/' + one.positionId.value + '.html?source=pl&i=pl-0',
        "target": "_blank",
        "href": 'https://www.lagou.com/center/job_' + one.positionId.value + '.html'
      }
    }, [_c('div', {
      staticClass: "yh-custom-position yh-custom-style3-base-element10 yh-custom-position-position clearfix",
      style: (_vm.setPositionStyle)
    }, [_c('div', {
      staticClass: "yh-custom-style3-base-element11 yh-custom-position-name position",
      style: ({
        color: _vm.props.h5css.position.value.positionName_color.value,
      })
    }, [_vm._v("\n" + _vm._s(one.positionName.value) + "\n")]), _vm._v(" "), _c('div', {
      staticClass: "yh-custom-style3-base-element12 yh-custom-position-salary salary",
      style: ({
        color: _vm.props.h5css.position.value.salary_color.value,
      })
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-loader/node_modules/vue-hot-reload-api").rerender("data-v-b759defa", module.exports)
  }
}
...
var update = __webpack_require__(9)("6f9d4166", content, false);
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-b759defa\",\"scoped\":false,\"hasInlineConfig\":false}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./index.vue", function() {
     var newContent = require("!!../../../../../node_modules/css-loader/index.js!../../../../../node_modules/vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-b759defa\",\"scoped\":false,\"hasInlineConfig\":false}!../../../../../node_modules/vue-loader/lib/selector.js?type=styles&index=0!./index.vue");
...
// module
exports.push([module.i, ".yh-custom-style3-base-element00 { margin:0 auto; width: 300px; height: 400px; border-color: rgb(255, 255, 255); border-width: 0px; border-style: none; border-radius: 0px; position: relative; background-color: rgb(255, 255, 255);}.yh-custom-style3-base-element0{left: 0rem; top: 0rem; position: absolute;}.yh-custom-style3-base-element1{width: 2.13333rem; height: 2.13333rem; background-color: rgb(255, 255, 255); border-color: rgb(255, 255, 255); border-width: 0px; border-style: none; border-radius: 0rem; box-shadow: rgb(255, 255, 255) 0rem 0rem 0rem;}.yh-custom-style3-base-element2{width: 100%; height: 100%; position: absolute; left: 0px; top: 0px; display: block;}.yh-custom-style3-base-element3{left: 0rem; top: 2.13333rem; position: absolute;}.yh-custom-style3-base-element4{width: 4.26667rem; height: 1.06667rem; line-height: 1.06667rem; border-color: rgb(255, 255, 255); border-width: 0px; border-style: none; border-radius: 0.170667rem; box-shadow: rgb(255, 255, 255) 0rem 0rem 0rem; font-size: 0.597333rem; color: rgb(255, 255, 255); text-align: center; background-color: rgb(255, 0, 132);}.yh-custom-style3-base-element5{width: 100%; height: 100%; position: absolute; left: 0px; top: 0px; display: block;}.yh-custom-style3-base-element6{left: 2.56rem; top: 0rem; position: absolute;}.yh-custom-style3-base-element7{width: 4.26667rem; height: 0.469333rem; line-height: 0.469333rem; font-size: 0.298667rem; color: rgb(102, 102, 102); text-align: left; font-style: normal; overflow: hidden; white-space: nowrap; text-overflow: ellipsis;}.yh-custom-style3-base-element8{left: 0rem; top: 4.26667rem; position: absolute;}.yh-custom-style3-base-element9{display: block;}.yh-custom-style3-base-element10{width: 5.33333rem; height: 0.469333rem; border-radius: 0rem; border-color: rgb(255, 255, 255); border-style: none; box-shadow: rgb(255, 255, 255) 0rem 0rem 0rem; overflow: hidden; background-color: rgb(255, 255, 255);}.yh-custom-style3-base-element11{width: 2.56rem; height: 0.469333rem; line-height: 0.469333rem; padding-left: 0.426667rem; font-size: 0.298667rem; color: rgb(102, 102, 102); text-align: left; font-style: normal; float: left; overflow: hidden; white-space: nowrap; text-overflow: ellipsis;}.yh-custom-style3-base-element12{width: 1.70667rem; height: 0.469333rem; line-height: 0.469333rem; padding-left: 0.213333rem; padding-right: 0.426667rem; font-size: 0.298667rem; color: rgb(102, 102, 102); text-align: left; font-style: normal; float: left; overflow: hidden; white-space: nowrap; text-overflow: ellipsis;}.yh-custom-style3-base-element13{display: block;}.yh-custom-style3-base-element14{width: 5.33333rem; height: 0.469333rem; border-radius: 0rem; border-color: rgb(255, 255, 255); border-style: none; box-shadow: rgb(255, 255, 255) 0rem 0rem 0rem; overflow: hidden; background-color: rgb(255, 255, 255);}.yh-custom-style3-base-element15{width: 2.56rem; height: 0.469333rem; line-height: 0.469333rem; padding-left: 0.426667rem; font-size: 0.298667rem; color: rgb(102, 102, 102); text-align: left; font-style: normal; float: left; overflow: hidden; white-space: nowrap; text-overflow: ellipsis;}.yh-custom-style3-base-element16{width: 1.70667rem; height: 0.469333rem; line-height: 0.469333rem; padding-left: 0.213333rem; padding-right: 0.426667rem; font-size: 0.298667rem; color: rgb(102, 102, 102); text-align: left; font-style: normal; float: left; overflow: hidden; white-space: nowrap; text-overflow: ellipsis;}.yh-custom-style3-base-element17{display: block;}.yh-custom-style3-base-element18{width: 5.33333rem; height: 0.469333rem; border-radius: 0rem; border-color: rgb(255, 255, 255); border-style: none; box-shadow: rgb(255, 255, 255) 0rem 0rem 0rem; overflow: hidden; background-color: rgb(255, 255, 255);}.yh-custom-style3-base-element19{width: 2.56rem; height: 0.469333rem; line-height: 0.469333rem; padding-left: 0.426667rem; font-size: 0.298667rem; color: rgb(102, 102, 102); text-align: left; font-style: normal; float: left; overflow: hidden; white-space: nowrap; text-overflow: ellipsis;}.yh-custom-style3-base-element20{width: 1.70667rem; height: 0.469333rem; line-height: 0.469333rem; padding-left: 0.213333rem; padding-right: 0.426667rem; font-size: 0.298667rem; color: rgb(102, 102, 102); text-align: left; font-style: normal; float: left; overflow: hidden; white-space: nowrap; text-overflow: ellipsis;}", ""]);
...
Component.options.__file = "/Users/dagou/Documents/workspace/20161117work/ecom-topic-fe/src/editorPC/components-h5/Custom/style3/index.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-b759defa", Component.options)
  } else {
    hotAPI.reload("data-v-b759defa", Component.options)
  }
