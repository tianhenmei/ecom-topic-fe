...
exports.default = {
    ...
    computed: {
        ...
        setmoreButtonStyle: function setmoreButtonStyle() {
            var style = '' + 'color:' + this.props.h5css.more_button.value.more_color.value + '; ';
            switch (this.props.h5css.more_button.value.more_background_type.value) {
                case 'background-color':
                    style += 'background:' + this.props.h5css.more_button.value.more_background_color.value + '; ';
                    break;
                case 'background-image':
                    style += 'background:' + this.props.h5css.more_button.value.more_background_color.value + ' ' + (this.props.h5css.more_button.value.more_background_image.value == 'none' || this.props.h5css.more_button.value.more_background_image.value == 'undefined' ? 'none' : 'url(' + this.props.h5css.more_button.value.more_background_image.value + ')') + ' ' + this.props.h5css.more_button.value.more_background_repeat.value + '; ';
                    break;
                case 'gradient-top-bottom':
                    style += '' + 'background:' + this.props.h5css.more_button.value.more_gradient_color_top.value + ';' + 'filter:alpha(opacity=100 finishopacity=100 style=1 startx=0,starty=0,finishx=0,finishy=150) progid:DXImageTransform.Microsoft.gradient(startcolorstr=' + this.props.h5css.more_button.value.more_gradient_color_top.value + ',endcolorstr=' + this.props.h5css.more_button.value.more_gradient_color_bottom.value + ',gradientType=0);' + '-ms-filter:alpha(opacity=100 finishopacity=100 style=1 startx=0,starty=0,finishx=0,finishy=150) progid:DXImageTransform.Microsoft.gradient(startcolorstr=' + this.props.h5css.more_button.value.more_gradient_color_top.value + ',endcolorstr=' + this.props.h5css.more_button.value.more_gradient_color_bottom.value + ',gradientType=0);' + 'background:-moz-linear-gradient(top, ' + this.props.h5css.more_button.value.more_gradient_color_top.value + '), ' + this.props.h5css.more_button.value.more_gradient_color_bottom.value + '); ' + 'background:-o-linear-gradient(top, ' + this.props.h5css.more_button.value.more_gradient_color_top.value + '), ' + this.props.h5css.more_button.value.more_gradient_color_bottom.value + '); ' + 'background:-webkit-gradient(linear,0 0,0 100%,color-stop(0%,' + this.props.h5css.more_button.value.more_gradient_color_top.value + '),color-stop(100%,' + this.props.h5css.more_button.value.more_gradient_color_bottom.value + '));' + '';
                    break;
                case 'gradient-left-right':
                    style += '' + 'background:' + this.props.h5css.more_button.value.more_gradient_color_left.value + ';' + 'filter:alpha(opacity=100 finishopacity=100 style=1 startx=0,starty=0,finishx=150,finishy=0) progid:DXImageTransform.Microsoft.gradient(startcolorstr=' + this.props.h5css.more_button.value.more_gradient_color_left.value + ',endcolorstr=' + this.props.h5css.more_button.value.more_gradient_color_right.value + ',gradientType=0);' + '-ms-filter:alpha(opacity=100 finishopacity=100 style=1 startx=0,starty=0,finishx=150,finishy=0) progid:DXImageTransform.Microsoft.gradient(startcolorstr=' + this.props.h5css.more_button.value.more_gradient_color_left.value + ',endcolorstr=' + this.props.h5css.more_button.value.more_gradient_color_right.value + ',gradientType=0);' + 'background:-moz-linear-gradient(left, ' + this.props.h5css.more_button.value.more_gradient_color_left.value + '), ' + this.props.h5css.more_button.value.more_gradient_color_right.value + '); ' + 'background:-o-linear-gradient(left, ' + this.props.h5css.more_button.value.more_gradient_color_left.value + '), ' + this.props.h5css.more_button.value.more_gradient_color_right.value + '); ' + 'background:-webkit-gradient(linear,0 0,100% 0,color-stop(0%,' + this.props.h5css.more_button.value.more_gradient_color_left.value + '),color-stop(100%,' + this.props.h5css.more_button.value.more_gradient_color_right.value + '));' + '';
                    break;
            }
            return style;
        }
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    staticClass: "yh-custom-button yh-custom-base-element4 yh-custom-button-btn",
    style: (_vm.setmoreButtonStyle)
  }, [_vm._v(_vm._s(_vm.props.data.more_button_text.value) + "\n")]), _vm._v(" "), _c('a', {
    staticClass: "yh-custom-base-element5 yh-custom-button-href yh-custom-href",
    attrs: {
      "lagou-href": 'https://www.lagou.com/gongsi/' + _vm.props.data.companyId.value + '.html',
      "target": "_blank",
      "href": 'https://www.lagou.com/gongsi/' + _vm.props.data.companyId.value + '.html'
...
// module
exports.push([module.i, ".yh-custom-base-element00 { margin:0 auto; width: 130px; height: 175px; border-color: rgb(255, 255, 255); border-width: 0px; border-style: none; border-radius: 6px; position: relative; background: -webkit-gradient(linear, 0 0, 0 100%, from(rgb(0, 255, 0)), to(rgb(255, 255, 0)));}.yh-custom-base-element0{left: 15px; top: 15px; position: absolute;}.yh-custom-base-element1{width: 100px; height: 100px; background-color: rgb(255, 255, 255); border-color: rgb(255, 255, 255); border-width: 0px; border-style: none; border-radius: 6px; box-shadow: rgb(255, 255, 255) 0px 0px 0px;}.yh-custom-base-element2{width: 100%; height: 100%; position: absolute; left: 0px; top: 0px; display: block;}.yh-custom-base-element3{left: 15px; top: 130px; position: absolute;}.yh-custom-base-element4{width: 100px; height: 30px; line-height: 30px; border-color: rgb(255, 255, 255); border-width: 0px; border-style: none; border-radius: 8px; box-shadow: rgb(255, 255, 255) 0px 0px 0px; font-size: 14px; color: rgb(255, 0, 255); text-align: center; background: -webkit-gradient(linear, 0 0, 0 100%, from(rgb(255, 255, 0)), to(rgb(0, 255, 0)));}.yh-custom-base-element5{width: 100%; height: 100%; position: absolute; left: 0px; top: 0px; display: block;}", ""]);
